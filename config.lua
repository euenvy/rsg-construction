...
Config.StuckPropCommand = false -- Enables command for stuck props
Config.DisableSprintJump = false -- Enable to disable sprint / jump while carrying plank
Config.Keys = {
    ["G"] = 0x760A9C6F,
}
...
Config.PayPerDrop = 0.25 -- Pay is 10 cents per drop
