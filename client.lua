...
local function PickupWoodLocation()
    ...
    RSGCore.Functions.Notify('Wood Location Mareked On your map!', 'error')
end
            ...
            if success then
                ...
                RSGCore.Functions.Progressbar("hammerwood", "Placing Wood...", (Config.PlaceTime * 1000), false, true, {
                    ...
                    if DropCount < Config.DropCount then
                        ...
                        RSGCore.Functions.Notify('You\'ve completed your work, you can collect your paycheck or get another task!', 'error') 
                    end
                end)

            else
                SetPedToRagdoll(PlayerPedId(), 1000, 1000, 0, 0, 0, 0)
                RSGCore.Functions.Notify('Never used a hammer before? Try again!', 'error') 
            end
        else
            RSGCore.Functions.Notify('You\'ve completed your work, you can collect your paycheck!', 'error') 
        end
    end
end)
